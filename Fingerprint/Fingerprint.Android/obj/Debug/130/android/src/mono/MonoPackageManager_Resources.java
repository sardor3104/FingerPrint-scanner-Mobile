...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Fingerprint.Android.dll" comes first in this list. */
		"Fingerprint.Android.dll",
		"BouncyCastle.Cryptography.dll",
		"EntryCustomReturn.Forms.Plugin.Abstractions.dll",
		"EntryCustomReturn.Forms.Plugin.Android.dll",
		"Fingerprint.dll",
		"FingerprintPro.ServerSdk.dll",
		"FormsViewGroup.dll",
		"Google.Apis.AndroidPublisher.v1.dll",
